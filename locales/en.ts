export const en = {
    ...
    settings: {
        ...
        inviteBtn: "+ Invite",
        inviting: "Sending...",
        inviteNotice: "An invitation email will be sent if the user doesn't exist.",
        yourAccount: "Your Account",
        limitReached: "Member limit reached for {plan} plan",
        upgradePlan: "Contact pablo@corlynxai.com to upgrade your plan or remove users.",
    },
    dashboard: {
        title: "Dashboard",
